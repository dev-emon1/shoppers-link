...
const InactiveVendors = lazy(
  () => import("../../views/admin/vendor-management/InactiveVendors"),
);
...
export const adminRoutes = [
  ...
  { path: "/admin/dashboard/overview", element: protectAdmin(Overview) },
  {
    ...
    element: protectAdmin(SalesAnalytics),
  },
  ...
  {
    path: "/admin/orders/refund-requests",
    element: protectAdmin(RefundRequest),
  },
  {
    path: "/admin/orders/return-management",
    element: protectAdmin(ReturnManagement),
  },
  {
    path: "/admin/orders/order-tracking",
    element: protectAdmin(OrderTracking),
  },
  { path: "/admin/vendors/all-vendors", element: protectAdmin(AllVendors) },
  {
    path: "/admin/vendors/onboarding-requests",
    element: protectAdmin(OnboardingVendor),
  },
  {
    path: "/admin/vendors/rejected-requests",
    element: protectAdmin(RejectVendor),
  },
  {
    path: "/admin/vendors/inactive-vendors",
    element: protectAdmin(InactiveVendors),
  },
  {
    path: "/admin/vendors/suspended-vendors",
    element: protectAdmin(SuspendedVendors),
  },
...
>>>>>>> 5f23822ac1c2cace21dbeea32a72bacb037ca79b
  { path: "/admin/reports/sales", element: protectAdmin(SalesReport) },
  {
    ...
    element: protectAdmin(ProductPerform),
  },
  {
    path: "/admin/reports/vendor-performance",
    element: protectAdmin(VendorPerform),
  },
