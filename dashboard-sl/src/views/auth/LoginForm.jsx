        ...
        <div className="relative">
          ...
          <input
            ...
            className={`pl-10 w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
              loginErrors.email ? "border-red-300" : "border-orange-300"
            }`}
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleLoginChange}
            className={`pl-10 w-full px-4 py-3 pr-12 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
              loginErrors.password ? "border-red-300" : "border-orange-300"
            }`}
