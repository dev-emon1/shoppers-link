    ...
    <div className="px-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        <div>
          ...
          <p className="text-gray-600">
            Total: {meta.total.toLocaleString()} customers
          </p>
        </div>
        <div className="flex gap-3">
          <button className="flex items-center gap-2 bg-main text-white px-4 py-2 rounded-lg hover:bg-mainHover transition text-sm">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-gray-50 transition">
                      ...
                      <td>
                        <button
                          onClick={() =>
                            navigate(`/vendor/users/customers/${c.id}`)
                          }
        ...
        <div className="px-6 py-4 bg-gray-50 border-t flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <p className="text-gray-600">
            Showing {(page - 1) * 10 + 1} to {Math.min(page * 10, meta.total)}{" "}
