    ...
    <div className="px-6 max-w-7xl mx-auto py-6">
      <div className="sm:flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-main text-white px-2 py-1 rounded-lg hover:bg-mainHover transition"
        >
          ...
          >
            <div className="h-40 bg-gray-100 relative">
              ...
              <div className="absolute top-2 right-2 flex gap-2">
                <button
                  ...
                  className="p-2 bg-white/90 rounded-full shadow hover:text-main"
                >
                  <Edit2 size={16} />
                </button>
                <button
            ...
            <div className="p-4">
              <div className="flex justify-between items-start mb-1">
                ...
                <span className="text-[10px] bg-gray-100 px-2 py-0.5 rounded uppercase font-bold">
                  {banner.position}
                </span>
              </div>
              ...
              <div className="text-[10px] text-gray-400">
                Created: {format(new Date(banner.created_at), "PPP")}
              </div>
            </div>
          </div>
        ))}
