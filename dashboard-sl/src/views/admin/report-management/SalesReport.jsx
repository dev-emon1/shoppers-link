        ...
        {summary && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 mb-2">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-xl font-bold text-gray-900 mt-2">
                {summary.total_quantity_sold?.toLocaleString() || 0}
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <p className="text-sm text-gray-600">Avg Order Value</p>
              <p className="text-xl font-bold text-gray-900 mt-2">
                {summary.average_order_value || "৳0.00"}
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="w-full">
                {" "}
                {/* Extra wrapper ensures 100% width */}
                <DatePicker
                  selected={startDate}
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <thead className="bg-gray-50 text-xs font-semibold uppercase text-gray-700 border-b border-gray-200">
                <tr>
                  <th
                    className="py-4 px-6 text-left cursor-pointer hover:bg-gray-100 transition"
                  ...
                  <th
                    className="py-4 px-6 text-right cursor-pointer hover:bg-gray-100 transition"
              ...
              <tbody className="divide-y divide-gray-100">
                {loading ? (
                  ...
                  sortedOrders.map((order) => (
                    ...
                    >
                      <td className="py-5 px-6 font-medium text-main">
                        #{order.order_id}
                      </td>
                      ...
                      <td className="py-5 px-6 text-right font-bold text-green-600">
