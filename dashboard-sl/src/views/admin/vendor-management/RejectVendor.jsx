...
const VendordataPage = () => {
  ...
  const handleApprove = async (vendorId) => {
    ...
    try {
      await API.patch(
        `/vendor/${vendors.find((v) => v.id === vendorId)?.user?.id}/approve`,
      );
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                  ...
                  return (
                    <tr key={v.id} className="hover:bg-gray-50 transition">
                      <td className="px-4 py-2">
                        <div className="flex items-center gap-3">
                          <div className="w-12 h-12 bg-gray-200 rounded-lg flex-center">
                            <Building2
                              size={24}
                              className="text-gray-500 ml-2.5 mt-2.5"
                            />
                          </div>
                          <div>
                      ...
                      <td className="px-4 py-2 text-sm">
                        <div className="flex items-center gap-2">
                          <Phone size={14} /> {v.contact_number}
                        </div>
                        <div className="flex items-center gap-2">
                          <Mail size={14} /> {v.user?.email}
                        </div>
                      </td>
        ...
        <div className="px-6 py-2 bg-gray-50 flex flex-col md:flex-row justify-between items-center gap-2 text-sm">
          ...
          <div className="flex gap-2">
            ...
            <span className="px-2 py-1 bg-main text-white rounded-lg">
              {page} / {totalPages}
            </span>
            <button
