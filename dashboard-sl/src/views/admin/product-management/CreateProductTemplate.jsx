...
export default function CreateProductTemplate() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("/api/product-templates", form)
      .then((res) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <select
        ...
        onChange={(e) =>
          setForm({ ...form, child_category_id: e.target.value })
        }
      >
