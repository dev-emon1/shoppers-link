...
import {
  activities,
  statusCardsData as initialCards,
...
=======
          <div
            key={item.id}
            className="w-full lg:w-[300px] bg-white rounded-lg shadow-md overflow-hidden"
          >
>>>>>>> 5f23822ac1c2cace21dbeea32a72bacb037ca79b
...
=======
            ...
            <div className="flex justify-between items-center mt-4 text-xs text-textSecondary bg-bgPage p-2">
              <p className="flex items-center">
                <span
                  className={`${item.isIncrease ? "text-green" : "text-red"} mr-2 flex items-center`}
                >
                  {item.isIncrease ? (
...
>>>>>>> 5f23822ac1c2cace21dbeea32a72bacb037ca79b
            ...
            <div className="flex justify-between items-center mt-4 text-xs text-textSecondary bg-bgPage p-2">
              ...
              {item.url && <Link to={item.url} className="font-semibold text-xs cursor-pointer hover:underline">View more</Link>}
            </div>
          </div>
        ))}
      </div>
...
=======
                  const primaryImage =
                    prod.images?.find((img) => img.is_primary === 1) ||
                    prod.images?.[0];
>>>>>>> 5f23822ac1c2cace21dbeea32a72bacb037ca79b
