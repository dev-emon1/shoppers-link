...
const EditShippingCharge = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(
        res.data.message || "Shipping charge updated successfully!",
      );
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {formData.areas.map((area, index) => (
                    <span
                      key={index}
                      className="flex items-center gap-2 bg-gray-50 border border-gray-200 px-3 py-1.5 rounded-lg text-xs font-bold text-gray-600"
                    >
                      {area}
                      <button
                        type="button"
