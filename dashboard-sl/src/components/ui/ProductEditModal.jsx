      ...
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-[95%] p-3 relative overflow-auto max-h-[90vh] mx-auto">
        <div className="px-2">
          <div className="flex justify-between items-center mb-2">
            ...
            <button
              onClick={onClose}
              className="text-main hover:text-mainHover fixed left-auto right-4 top-8"
            >
              <RiCloseLine size={28} />
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-white border border-border rounded-md p-2 shadow-sm">
              ...
              <textarea
                value={shortDesc}
                onChange={(e) =>
                  e.target.value.length <= MAX_SHORT &&
              ...
              />
              <span
                className={`text-sm ${shortDesc.length > MAX_SHORT ? "text-red-600" : "text-gray-500"}`}
              >
            ...
            <div className="bg-white border border-border rounded-md shadow-sm">
              <div className="p-4">
                ...
                <span className="text-sm text-gray-500">
                  {longDesc.length.toLocaleString()} chars
                </span>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <span
                  className={`text-xs ${formData.meta_title.length > MAX_TITLE ? "text-red-600" : "text-gray-500"}`}
                >
